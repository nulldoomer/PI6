...
@section('title', __('main.Patient_Edit'))
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('main.Patient_Edit') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>{{ __('main.Patient_Edit') }}</h3>
                        @can('patient-list')
                            <a class="btn btn-primary ml-auto" href="{{ route('patient.index') }}">{{ __('main.List') }}</a>
                        @endcan
                    </div>
                    <div class="card-body">
                        <div class="row">
